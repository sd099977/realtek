...
typedef struct{
	...
	unsigned int bootcode2_secu_mode;
	unsigned int bootcode2_addr;
	unsigned int bootcode2_size;
	unsigned int bootcode3_secu_mode;
	unsigned int bootcode3_addr;
	unsigned int bootcode3_size;
	
} __attribute__((aligned(8))) t_spi_extern_param;
