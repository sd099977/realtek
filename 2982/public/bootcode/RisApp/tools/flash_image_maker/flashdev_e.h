...
#define CR_CLKSEL               SYS_CLKSEL        //0xB8000040
#define EMMC_DIV_MASK           (0x07UL<<4)
#define EMMC_DIV_W_EN           (0x01UL<<7)
#define CR_DIV_MASK             (0x07UL<<0)
#define CR_DIV_W_EN             (0x01UL<<3)
#define CREMMC_CLK_DEL          (0x01UL<<30)
#define CREMMC_CLK_DEL_W_EN     (0x01UL<<31)

//#define CARD_SWITCHCLOCK_60MHZ  (0x00UL<<12)
//#define CARD_SWITCHCLOCK_80MHZ  (0x01UL<<12)
//#define CARD_SWITCHCLOCK_98MHZ  (0x02UL<<12)
//#define CARD_SWITCHCLOCK_98MHZS (0x03UL<<12)
//#define CARD_SWITCHCLOCK_30MHZ  (0x04UL<<12)
//#define CARD_SWITCHCLOCK_40MHZ  (0x05UL<<12)
//#define CARD_SWITCHCLOCK_49MHZ  (0x06UL<<12)
//#define CARD_SWITCHCLOCK_49MHZS (0x07UL<<12)
