...
#define APP_STACK_SIZE    0x00000200    /* 512 bytes (reduce simulation time) */
#else
#define APP_STACK_SIZE    0x00001000    /* 4K bytes */
#endif
//#define APPISR_STACK_SIZE 0x00002000    /* 8K bytes */

/* Memory allocation */
#define APP_STACK_USE_DMEM

/* Mask to switch between memory segment */
