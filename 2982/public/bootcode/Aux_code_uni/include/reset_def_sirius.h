...
#define DEFAULT_KBOOT_ADDR	0x19f00000	/* kboot start address */
...
#define HWSETTING_IN_CP42K_SRAM_SIZE	0x1000
#define HWSETTING_IN_CP42K_SRAM_ADDR	(CP42K_SRAM_ADDR + CP42K_SRAM_SIZE - HWSETTING_IN_CP42K_SRAM_SIZE)

#define PARA_START_IN_CP42K_SRAM_ADDR		0xb8079000

//#define HAS_RECOVERY_FUNCTION		// recovery mode console function move to ACPU_recovery

#define VER_A 0x63300000
#define VER_B 0x63300001
#define VER_C 0x63300002
