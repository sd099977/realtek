...
#ifndef __CONFIG_RTK_298X_QC_VERIFY_QFP176_H
#define __CONFIG_RTK_298X_QC_VERIFY_QFP176_H
...
/* Define each ip */
#if CONFIG_EQC
#define CONFIG_QC_SCPU   1
#define CONFIG_QC_GPU   1
#define CONFIG_QC_VE   1
#define CONFIG_QC_AUDIO 1
#define CONFIG_QC_GETN   1
#define CONFIG_QC_HDMI_RX  1
#define CONFIG_QC_CEC   1
#define CONFIG_QC_I_DOMAIN   1
#define CONFIG_QC_IFD   1
#define CONFIG_QC_MD_DOMAIN  1
#define CONFIG_QC_PERIPHERAL 1
#define CONFIG_QC_SPI   1
#define CONFIG_QC_USB   1
#define CONFIG_QC_VIP   1
#define CONFIG_QC_VDC   1
#define CONFIG_QC_VBI   1
#define CONFIG_QC_I3DDMA     1
#define CONFIG_QC_EMMC  1
#define CONFIG_QC_NAND  1
...
#define CONFIG_QC_TVE_CGMS_YPP_OUTPUT_TEST 0
#if CONFIG_BGA
...
#endif /* __CONFIG_RTK_298X_QC_VERIFY_QFP176_H */
