...
#ifndef __CONFIG_RTK_298X_TV003_OEM_512M_X16_V2_NAND_H
#define __CONFIG_RTK_298X_TV003_OEM_512M_X16_V2_NAND_H
...
/* Board config name */
#define CONFIG_BOARD_298X_TV003_OEM_QFP176_V2_NAND
...
/* panel */
#define CONFIG_PANEL_NAME "asm/arch/panel/sharp_oem_auo_t550hvn03.h"

/* Bootcode Feature: Detect install.img from USB when AC on */
#define CONFIG_USB_UPDATE_WHEN_AC_ON

/* Bootcode Feature: when AC on, the current power mode follows the previous power status  */
#define CONFIG_BOOTUP_BY_PREV_POWER_STATUS

#endif /*__CONFIG_RTK_298X_TV003_OEM_512M_X16_V2_NAND_H */
