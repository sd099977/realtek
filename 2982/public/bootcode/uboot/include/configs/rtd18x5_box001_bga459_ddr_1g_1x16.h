/*
 * Configuration settings for the Realtek 18X5 Demo board.
 *
 * Won't include this file.
 * Just type "make <board_name>_config" and will be included in source tree.
 */

#ifndef __CONFIG_RTK_18X5_BOX001_1G_1X16_H
#define __CONFIG_RTK_18X5_BOX001_1G_1X16_H
...
/*
 * Include the common settings of RTD18X5 platform.
 */
#include <configs/rtd18x5_common.h>

#define IS_BOX

/*
 * The followings were RTD18X5 demo board specific configuration settings.
 */

/* Board config name */
#define CONFIG_BOARD_18X5_BOX001_BGA459_EMMC
...
#endif /* __CONFIG_RTK_18X5_BOX001_1G_1X16_H */
