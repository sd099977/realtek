...
#define RTD298X_QFP176_PIN_6								(0x0C&0x1F)//0xB80008F0[31:27];
...
#define RTD298X_QFP176_PIN_7								(0x0C&0x1F)//0xB80008F0[26:22];
...
#define RTD298X_QFP176_PIN_8								(0x0C&0x1F)//0xB80008F0[21:17];
																							//0C: BB_AI3L,<AI>
																							//0D: misc_uni_pwm5,<O>
																							//0E: misc_pwm_7,<OD>
...
#define RTD298X_QFP176_PIN_9								(0x0C&0x1F)//0xB80008F0[16:12];
																							//0A: SPDIF_OUT,<O>
																							//0C: BB_AI3R,<AI>
																							//0D: misc_uni_pwm7,<O>
																							//0E: misc_pwm_6,<OD>
...
#define RTD298X_QFP176_PIN_11								(0x0C&0x1F)//0xB80008F4[26:22];
																							//03: TCON_bit19,<O>
																							//0A: SPDIF_OUT,<O>
																							//0C: BB_AIO1L,<AO>
																							//0D: misc_uni_pwm1,<O>
...
#define RTD298X_QFP176_PIN_12								(0x0C&0x1F)//0xB80008F4[21:17];
																							//03: TCON_bit1,<O>
																							//0C: BB_AIO1R,<AO>
																							//12: I2S_out_WCLK,<O>
...
#define RTD298X_QFP176_PIN_42								(0x1F&0x1F)//0xB8000814[13:9];
...
#define RTD298X_QFP176_PIN_43								(0x1F&0x1F)//0xB8000818[31:27];
...
#define RTD298X_QFP176_PIN_44								(0x0A&0x1F)//0xB8000818[22:18];
...
#define RTD298X_QFP176_PIN_45								(0x1F&0x1F)//0xB8000818[13:9];
...
#define RTD298X_QFP176_PIN_74								(0x1F&0x1F)//0xB80008B8[31:27];
																							//00: LVDS_A_HP,<AO>
																							//01: SPI_CS_N,<O>,<HS>
																							//03: TCON_bit8,<O>
																							//09: IRTX,<O>
...
#define RTD298X_QFP176_PIN_75								(0x0D&0x1F)//0xB80008B8[21:17];
...
#define RTD298X_QFP176_PIN_126								(0x0C&0x1F)//0xB806020C[11:7];
																							//0C: LSADC2,<AI>
...
#if 1//(defined ENABLE_TCON_MODULE) //Dimmer PWM setting
#define PWM_FREQ            (10000)
#define PWM_DUTY_MAX	    (900)
#define Customer_PWM_Index  (3)

#define PIN_BL_ADJ              RTD298X_QFP176_PIN_75_PWM_3(1, PWM_FREQ, (PWM_DUTY_MAX-1), PWM_DUTY_MAX)	

#else
#define PIN_BL_ADJ				RTD298X_QFP176_PIN_74_PWM_3(1, 200, 255, 254)
#endif

#define PIN_BL_ON_OFF 			RTD298X_QFP176_PIN_129_ISO_GPO_47(1, 0)

#define PIN_BL_ERR			    RTD298X_QFP176_PIN_76_GPI_82(0)
#define PIN_LVDS_ON_OFF			RTD298X_QFP176_PIN_45_GPO_19(0, 1)


// Vol down
#define PIN_KEYPAD_LEFT			RTD298X_QFP176_PIN_125_LSADC_VOLTAGE_1(51, 10)
// Vol up
#define PIN_KEYPAD_RIGHT		RTD298X_QFP176_PIN_125_LSADC_VOLTAGE_1(0, 10)


// Ch down
#define PIN_KEYPAD_DOWN		RTD298X_QFP176_PIN_124_LSADC_VOLTAGE_0(51, 10)

// Ch up
#define PIN_KEYPAD_UP		RTD298X_QFP176_PIN_124_LSADC_VOLTAGE_0(0, 10)

// Input
#define PIN_KEYPAD_SELECT    RTD298X_QFP176_PIN_124_LSADC_VOLTAGE_0(97, 10)

//Menu
#define PIN_KEYPAD_MENU 		RTD298X_QFP176_PIN_125_LSADC_VOLTAGE_1(97, 10)

// Power
#define PIN_KEYPAD_PWR			RTD298X_QFP176_PIN_105_ISO_GPI_7(1)
...
#define PIN_LED_W					RTD298X_QFP176_PIN_123_ISO_GPO_0(0,0)
...
#define PIN_VCOM_WP                 RTD298X_QFP176_PIN_43_GPO_17(0, 0)
//#define PIN_PANEL_ENABLE            RTD298X_QFP176_PIN_45_GPO_19(0, 1)

#define PIN_OPC                     RTD298X_QFP176_PIN_126_LSADC_VOLTAGE_2(0, 10)
#define PIN_TEMP_DETECT             RTD298X_QFP176_PIN_127_LSADC_VOLTAGE_7(10, 10)
#define PIN_HP_PLUG                 RTD298X_QFP176_PIN_172_GPI_126(0)
