...
#define PIN_DIMMER              RTD298X_QFP176_PIN_75_PWM_3(1, PWM_FREQ, (PWM_DUTY_MAX-1), PWM_DUTY_MAX)	
...
#define PIN_BL_ON_OFF 			RTD298X_QFP176_PIN_42_GPO_16(0, 0)
...
#define PIN_AMP_MUTE			RTD298X_QFP176_PIN_109_ISO_GPO_11(1,0)   // 0: unmute  1: mute
...
#define PIN_HP_PLUG                 RTD298X_QFP176_PIN_1_GPI_129(0)
...
#if 1//(defined ENABLE_TCON_MODULE)
PCB_ENUM(PIN_DIMMER)
#else
PCB_ENUM(PIN_BL_ADJ)
#endif
