...
#define NAND_EXTERN_PARAM_BLOCK_NO	0x10		//BLOCK 0xc
#define NAND_EXTERN_PARAM_BYTE_SIZE	0x00000800
#define NAND_RESCURE_LOGO_BLK_ADDR	(NAND_EXTERN_PARAM_BLOCK_NO+1)


#define EMMC_RESCUE_LINUX_ADDR		0x100000
#define EMMC_RESCUE_LINUX_BLOCK_NO	(EMMC_RESCUE_LINUX_ADDR >> 9)
...
#define KERNEL_RSV_MEM_MAGICNO		0x2379beef
...
typedef struct {
	uint	dwMagicNumber;		// magic number must be 0x2379beef
	uint	dwEntryCount;		// available entries
...
/* sync from system/tools/install_a/include/rtk_boottable.h */
#define TAG_COMPLETE	21	/* don't change this value */

extern BOOT_FLASH_T boot_flash_type;
extern BOOT_MODE boot_mode;
extern uint boot_tag;
