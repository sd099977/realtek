#include <platform_lib/board/pcb_rtd298x_qfp176_library.h>
...
#define RTD298X_QFP176_PIN_6								(0x1F&0x1F)//0xB80008F0[31:27];
...
#define RTD298X_QFP176_PIN_7								(0x1F&0x1F)//0xB80008F0[26:22];
...
#define RTD298X_QFP176_PIN_8								(0x1F&0x1F)//0xB80008F0[21:17];
																							//0C: BB_AI3L,<AI>
																							//0D: misc_uni_pwm5,<O>
																							//0E: misc_pwm_7,<OD>
...
#define RTD298X_QFP176_PIN_9								(0x1F&0x1F)//0xB80008F0[16:12];
																							//0A: SPDIF_OUT,<O>
																							//0C: BB_AI3R,<AI>
																							//0D: misc_uni_pwm7,<O>
																							//0E: misc_pwm_6,<OD>
...
#define RTD298X_QFP176_PIN_11								(0x1F&0x1F)//0xB80008F4[26:22];
																							//03: TCON_bit19,<O>
																							//0A: SPDIF_OUT,<O>
																							//0C: BB_AIO1L,<AO>
																							//0D: misc_uni_pwm1,<O>
...
#define RTD298X_QFP176_PIN_12								(0x1F&0x1F)//0xB80008F4[21:17];
																							//03: TCON_bit1,<O>
																							//0C: BB_AIO1R,<AO>
																							//12: I2S_out_WCLK,<O>
...
#define RTD298X_QFP176_PIN_14								(0x0C&0x1F)//0xB80008F4[16:12];
																							//03: TCON_bit2,<O>
																							//0C: BB_HPOL,<AO>
																							//0D: misc_uni_pwm4,<O>
																							//0E: misc_pwm_4,<OD>
...
#define RTD298X_QFP176_PIN_15								(0x0C&0x1F)//0xB80008F4[11:7];
																							//03: TCON_bit3,<O>
																							//0C: BB_HPOR,<AO>
...
#define RTD298X_QFP176_PIN_16								(0x1F&0x1F)//0xB80008F8[31:27];
																							//03: TCON_bit4,<O>
																							//04: TCON_bit20,<O>
																							//06: uart0_rXdi_src5,<I>
																							//0A: SPDIF_OUT,<O>
																							//0D: misc_uni_pwm7,<O>
																							//0E: misc_pwm_6,<OD>
																							//1F: MIS_GPIO_bit194,<I/O>
																							//def: MIS_GPIO_bit194,<I/O>

// PAD_NAME: BB_DIO2_APAD 10
#define RTD298X_QFP176_PIN_17								(0x1F&0x1F)//0xB80008F8[26:22];
																							//03: TCON_bit5,<O>
																							//04: TCON_bit21,<O>
																							//06: uart0_tXdo,<O>
																							//0E: misc_pwm_4,<OD>
																							//1F: MIS_GPIO_bit195,<I/O>
																							//def: MIS_GPIO_bit195,<I/O>

// PAD_NAME: BB_DIO3_APAD 11
#define RTD298X_QFP176_PIN_18								(0x1F&0x1F)//0xB80008F8[21:17];
																							//03: TCON_bit6,<O>
																							//04: TCON_bit22,<O>
																							//0D: misc_uni_pwm5,<O>
																							//0E: misc_pwm_7,<OD>
...
#define RTD298X_QFP176_PIN_38								(0x13&0x1F)//0xB8000800[31:27];
																							//11: ATV_RF_AGC,<OD>
																							//12: DEMOD_AGC_RF,<OD>
																							//13: ATV_IF_AGC,<OD>
																							//14: DEMOD_AGC_IF,<OD>
...
#define RTD298X_QFP176_PIN_42								(0x13&0x1F)//0xB8000814[13:9];
...
#define RTD298X_QFP176_PIN_43								(0x13&0x1F)//0xB8000818[31:27];
...
#define RTD298X_QFP176_PIN_44								(0x13&0x1F)//0xB8000818[22:18];
...
#define RTD298X_QFP176_PIN_45								(0x0B&0x1F)//0xB8000818[13:9];
...
#define RTD298X_QFP176_PIN_46								(0x00&0x1F)//0xB8000830[31:27];
																							//00: nf_tmX_cle,<O>,<HS>
																							//01: SPI_SCLK,<O>,<HS>
																							//02: EMMC_CLK,<O>,<HS>
																							//03: TCON_bit14,<O>
...
#define RTD298X_QFP176_PIN_47								(0x00&0x1F)//0xB8000830[22:18];
																							//00: nf_tmX_wr_n,<O>,<HS>
																							//01: SPI_DI,<I/O>,<HS>
																							//03: TCON_bit15,<O>
																							//09: ETN_LED_LINK,<O>
...
#define RTD298X_QFP176_PIN_49								(0x00&0x1F)//0xB8000834[31:27];
																							//00: nf_tmX_ale,<O>,<HS>
																							//01: SPI_DO,<I/O>,<HS>
																							//03: TCON_bit17,<O>
...
#define RTD298X_QFP176_PIN_53								(0x00&0x1F)//0xB8000828[13:9];
																							//00: nf_tmX_ce_n_bit0,<O>,<HS>
...
#define RTD298X_QFP176_PIN_54								(0x00&0x1F)//0xB8000834[13:9];
...
#define RTD298X_QFP176_PIN_55								(0x00&0x1F)//0xB8000838[31:27];
...
#define RTD298X_QFP176_PIN_56								(0x00&0x1F)//0xB8000838[22:18];
...
#define RTD298X_QFP176_PIN_57								(0x00&0x1F)//0xB8000838[13:9];
...
#define RTD298X_QFP176_PIN_58								(0x00&0x1F)//0xB800083C[31:27];
...
#define RTD298X_QFP176_PIN_59								(0x00&0x1F)//0xB800083C[22:18];
...
#define RTD298X_QFP176_PIN_60								(0x00&0x1F)//0xB800083C[13:9];
...
#define RTD298X_QFP176_PIN_61								(0x00&0x1F)//0xB8000840[31:27];
...
#define RTD298X_QFP176_PIN_62								(0x00&0x1F)//0xB8000840[22:18];
																							//00: nf_tmX_rd_n,<O>,<HS>
																							//02: EMMC_CLK,<O>,<HS>
																							//03: TCON_bit19,<O>
...
#define RTD298X_QFP176_PIN_63								(0x00&0x1F)//0xB8000844[13:9];
...
#define RTD298X_QFP176_PIN_107								(0x0B&0x1F)//0xB806024C[31:27];
																							//02: ST_dbg_bit2,<I/O>
...
#define RTD298X_QFP176_PIN_110								(0x1F&0x1F)//0xB8060248[31:27];
																							//01: EMMC_CLK,<O>,<HS>
																							//02: ST_dbg_bit4,<I/O>
...
#define RTD298X_QFP176_PIN_114								(0x1F&0x1F)//0xB8060244[22:18];
																							//02: ST_dbg_bit14,<I/O>
...
#define RTD298X_QFP176_PIN_127								(0x0C&0x1F)//0xB806020C[26:22];
																							//0C: LSADC7,<AI>
...
//#define PIN_BL_ON_OFF         RTD298X_QFP176_PIN_42_GPO_16(0, 0) //Modified for OEM project
#define PIN_BL_ADJ              RTD298X_QFP176_PIN_74_PWM_3(1, 200, 255, 254)
#define PIN_LVDS_ON_OFF         RTD298X_QFP176_PIN_76_GPO_82(0, 1)

//#define PIN_DIMMER            RTD298X_QFP176_PIN_75_PWM_3(1, 200, 255, 254)	
	

// Vol down
#define PIN_KEYPAD_LEFT         RTD298X_QFP176_PIN_125_LSADC_VOLTAGE_1(144, 15)
// Vol up
#define PIN_KEYPAD_RIGHT        RTD298X_QFP176_PIN_125_LSADC_VOLTAGE_1(76, 15)
// Ch down
#define PIN_KEYPAD_DOWN         RTD298X_QFP176_PIN_125_LSADC_VOLTAGE_1(32, 15)
// Ch up
#define PIN_KEYPAD_UP           RTD298X_QFP176_PIN_124_LSADC_VOLTAGE_0(132, 15)
// Input
#define PIN_KEYPAD_SELECT       RTD298X_QFP176_PIN_124_LSADC_VOLTAGE_0(80, 15)
// Menu
#define PIN_KEYPAD_MENU         RTD298X_QFP176_PIN_124_LSADC_VOLTAGE_0(48, 15)
// Power
#define PIN_KEYPAD_PWR			RTD298X_QFP176_PIN_124_LSADC_VOLTAGE_0(20, 15)

	// HDMI 1 reletive board information
#define PIN_HDMI1_HOTPLUG		RTD298X_QFP176_PIN_120_ISO_GPO_22(1, 0)
...
#define PIN_HDMI2_HOTPLUG		RTD298X_QFP176_PIN_117_ISO_GPO_19(1, 0)
...
#define PIN_HDMI_MHL_SEL        RTD298X_QFP176_PIN_110_ISO_GPO_12(0, 1)
#define PIN_MHL_IN              RTD298X_QFP176_PIN_111_ISO_GPI_13(0)
#define PIN_LEDR                (0) //Modified for OEM project
...
//#define I2C_PORT_4                      PCB_GPIO_I2C(PIN_I2C4_SDA, PIN_I2C4_SCL)
	...
	#define PIN_AMP_MUTE            RTD298X_QFP176_PIN_109_ISO_GPO_11(0,1)   // 0: unmute  1: mute
...
//#define PIN_MISC_2D_3D_SELECT				RTD299X_BGA_PIN_Y6_GPO_136(0, 0)
	//#define FLASH_WP
	//#define MISC_951_RST
//#define PIN_POWER_DETECT		RTD298X_QFP176_PIN_90_GPI_83(0)
#define PIN_HDMI2_IN				RTD298X_QFP176_PIN_90_GPI_83(0)
#define PIN_POWER_EN				RTD298X_QFP176_PIN_108_ISO_GPO_10(0, 1)
#define PIN_AC_CTRL				    RTD298X_QFP176_PIN_114_ISO_GPO_16(0, 1)
...
//#define PIN_VCOM_WP               RTD298X_QFP176_PIN_43_GPO_17(0, 0) //Modified for OEM project
//#define PIN_PANEL_ENABLE          RTD298X_QFP176_PIN_45_GPO_19(0, 1) //Modified for OEM project

//#define PIN_OPC                   RTD298X_QFP176_PIN_126_LSADC_VOLTAGE_2(0, 10) //Modified for OEM project
#define PIN_TEMP_DETECT             RTD298X_QFP176_PIN_127_LSADC_VOLTAGE_7(10, 10)
//#define PIN_HP_PLUG               RTD298X_QFP176_PIN_1_GPI_129(0) //Modified for OEM project

//New definition for OEM project
#define PIN_LOGO_WHITE_DIM          RTD298X_QFP176_PIN_123_ISO_GPO_0(0, 0)
#define PIN_WIFI_RESET              RTD298X_QFP176_PIN_126_ISO_GPO_3(0, 0)
//#define PIN_12V_ON_OFF            RTD298X_QFP176_PIN_114_ISO_GPO_16(0, 1)

#define PIN_AMP_RST                 RTD298X_QFP176_PIN_6_GPO_130(0, 1)
#define PIN_LINE_OUT_MUTE           RTD298X_QFP176_PIN_7_GPO_131(0, 0)
#define PIN_BL_ON_OFF               RTD298X_QFP176_PIN_8_GPO_132(0, 0)
#define PIN_VCOM_WP                 RTD298X_QFP176_PIN_9_GPO_133(0, 0)
#define PIN_PANEL_ENABLE            RTD298X_QFP176_PIN_11_GPO_136(0, 1)
#define PIN_AC_OFF_DET              RTD298X_QFP176_PIN_12_GPI_137(0)
...
//PCB_ENUM(PIN_BL_ON_OFF) //Modified for OEM project
PCB_ENUM(PIN_BL_ADJ)
...
PCB_ENUM(PIN_POWER_EN)
PCB_ENUM(PIN_AC_CTRL)
PCB_ENUM(PIN_HDMI2_IN)

//PCB_ENUM(PIN_VCOM_WP) //Modified for OEM project
//PCB_ENUM(PIN_PANEL_ENABLE) //Modified for OEM project
//PCB_ENUM(PIN_DIMMER) //Modified for OEM project
//PCB_ENUM(PIN_OPC) //Modified for OEM project
PCB_ENUM(PIN_TEMP_DETECT)
//PCB_ENUM(PIN_HP_PLUG) //Modified for OEM project

//New definition for OEM project
PCB_ENUM(PIN_LOGO_WHITE_DIM)
PCB_ENUM(PIN_WIFI_RESET)
//PCB_ENUM(PIN_12V_ON_OFF)
PCB_ENUM(PIN_AMP_RST)
PCB_ENUM(PIN_LINE_OUT_MUTE)
PCB_ENUM(PIN_BL_ON_OFF)
PCB_ENUM(PIN_VCOM_WP)
PCB_ENUM(PIN_PANEL_ENABLE)
PCB_ENUM(PIN_AC_OFF_DET)
