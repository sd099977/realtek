...
#define PWM0_TIMING_CTRL_reg		(MIS_PWM0_TIMING_CTRL_reg)
#define PWM0_DUTY_SET_reg			(MIS_PWM0_DUTY_SET_reg)
#define PWM0_CTRL_reg				(MIS_PWM0_CTRL_reg)

#define ISO_PWM0_CTRL_reg			(0xb8061284)
#define ISO_PWM0_TIMING_CTRL_reg	(0xb8061288)
#define ISO_PWM0_DUTY_SET_reg		(0xb806128c)
