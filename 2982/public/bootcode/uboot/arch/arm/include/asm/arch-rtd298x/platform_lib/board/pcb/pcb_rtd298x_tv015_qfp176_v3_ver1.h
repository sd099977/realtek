...
#define RTD298X_QFP176_PIN_1								(0x0C&0x1F)//0xB80008EC[21:17];		//*#*
																							//03: TCON_bit16,<O>
																							//0C: VDAC_OUT,<AO>
...
#define RTD298X_QFP176_PIN_8								(0x1F&0x1F)//0xB80008F0[16:12];		
																							//0A: SPDIF_OUT,<O>
																							//0C: BB_AI3R,<AI>
																							//0D: misc_uni_pwm7,<O>
																							//0E: misc_pwm_6,<OD>
...
#define RTD298X_QFP176_PIN_15								(0x1F&0x1F)//0xB80008F8[21:17];		//*#* ? (EMMC_RSTN)
																							//03: TCON_bit6,<O>
																							//04: TCON_bit22,<O>
																							//0D: misc_uni_pwm5,<O>
																							//0E: misc_pwm_7,<OD>
...
#define RTD298X_QFP176_PIN_39								(0x12&0x1F)//(0x12&0x1F)//0xB8000800[22:18];	//*#*
...
#define RTD298X_QFP176_PIN_40								(0x12&0x1F)//(0x12&0x1F)//0xB8000804[31:27];	//*#*
...
#define RTD298X_QFP176_PIN_44								(0x1F&0x1F)//0xB8000818[22:18];		//*#*
...
#define RTD298X_QFP176_PIN_64								(0x0F&0x1F)//0xB8000840[13:9];		//*#*
...
#define RTD298X_QFP176_PIN_65								(0x0F&0x1F)//0xB8000844[31:27];		//*#*
...
#define PIN_BL_ADJ				RTD298X_QFP176_PIN_74_PWM_3(0, 200, 255, 255)		//*#*(R717=100 & R712=NC)

#define PIN_LVDS_ON_OFF		RTD298X_QFP176_PIN_76_GPO_82(0, 1)
#define PIN_RLED_ON_OFF 		RTD298X_QFP176_PIN_123_ISO_GPO_0(1,0)	//*#*	
#define PIN_GLED_ON_OFF 		RTD298X_QFP176_PIN_126_ISO_GPO_3(1,1)	//*#*		

#if 1//715G6316-K01 keypad
#define PIN_KEYPAD_RIGHT		RTD298X_QFP176_PIN_124_LSADC_VOLTAGE_0(15, 3)	//0x0F
#define PIN_KEYPAD_LEFT		RTD298X_QFP176_PIN_124_LSADC_VOLTAGE_0(  8, 3)	//0x08
#define PIN_KEYPAD_UP			RTD298X_QFP176_PIN_124_LSADC_VOLTAGE_0(43, 3)	//0x2B
#define PIN_KEYPAD_DOWN		RTD298X_QFP176_PIN_124_LSADC_VOLTAGE_0(31, 3)	//0x1F
#define PIN_KEYPAD_MENU		RTD298X_QFP176_PIN_124_LSADC_VOLTAGE_0(  0, 3)	//0x00
#else//715Gxxxx-K01 keypad	
#define PIN_KEYPAD_RIGHT			RTD298X_QFP176_PIN_124_LSADC_VOLTAGE_0(48, 3)	//0x30
#define PIN_KEYPAD_LEFT			RTD298X_QFP176_PIN_124_LSADC_VOLTAGE_0(38, 3)	//0x25
#define PIN_KEYPAD_UP			RTD298X_QFP176_PIN_124_LSADC_VOLTAGE_0(30, 3)	//0x1E
#define PIN_KEYPAD_DOWN			RTD298X_QFP176_PIN_124_LSADC_VOLTAGE_0(21, 3)	//0x15
#define PIN_KEYPAD_MENU			RTD298X_QFP176_PIN_124_LSADC_VOLTAGE_0(15, 3)	//0x0E
#define PIN_KEYPAD_SOURCE		RTD298X_QFP176_PIN_124_LSADC_VOLTAGE_0(  8, 3)	//0x08	
#define PIN_KEYPAD_PWR			RTD298X_QFP176_PIN_125_LSADC_VOLTAGE_1(  0,12)	//0x08
#endif
...
#define PIN_HDMI_MHL_SELECT	RTD298X_QFP176_PIN_107_ISO_GPO_9(0, 1)	//HDMI_MHL_SEL
#define PIN_HDMI_CABLE_DETECT	RTD298X_QFP176_PIN_44_GPI_18(0)			//HDMI2_CON5V 	//*#*
#define PIN_MHL_CABLE_DETECT	RTD298X_QFP176_PIN_111_ISO_GPI_13(0)	//MHL_IN

#define PIN_HDMI0_CABLE_DETECT	RTD298X_QFP176_PIN_42_GPI_16(0)		//HDMI0_CON5V	//*#*
#define PIN_HDMI1_CABLE_DETECT	RTD298X_QFP176_PIN_43_GPI_17(0)		//HDMI1_CON5V	//*#*
...
//#define PIN_I2C1_SCL			RTD298X_QFP176_PIN_39_GPO_1(0,0)					//*#*
//#define PIN_I2C1_SDA			RTD298X_QFP176_PIN_40_GPO_2(0,0)					//*#*
//#define I2C_PORT_1				PCB_GPIO_I2C(PIN_I2C1_SDA, PIN_I2C1_SCL)				//*#*
...
#define PIN_AMP_MUTE			RTD298X_QFP176_PIN_109_ISO_GPO_11(0,0)	//*#*	
...
#define PIN_EEPROM_WP 			RTD298X_QFP176_PIN_8_GPO_133(0,0)	
//#define PIN_EEP_CLK 				RTD298X_QFP176_PIN_65_GPO_54(0,0)
//#define PIN_EEP_DATA 			RTD298X_QFP176_PIN_64_GPO_53(0,0)
...
#define PIN_POWER_EN			RTD298X_QFP176_PIN_105_ISO_GPO_7(0, 1)	//*#*	
...
PCB_ENUM(PIN_RLED_ON_OFF)
PCB_ENUM(PIN_GLED_ON_OFF)
#if 1//715G6316-K01 keypad
...
PCB_ENUM(PIN_HDMI0_CABLE_DETECT)
PCB_ENUM(PIN_HDMI1_CABLE_DETECT)
...
PCB_ENUM(PIN_EEPROM_WP)
//PCB_ENUM(PIN_EEP_CLK)
//PCB_ENUM(PIN_EEP_DATA)
