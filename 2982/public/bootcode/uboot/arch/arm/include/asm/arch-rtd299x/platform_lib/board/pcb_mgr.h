...
typedef enum {
	PCB_AUDIO_OUTPUT_AOUT_PAD,
	PCB_AUDIO_OUTPUT_SCART_PAD,
} PCB_AUDIO_OUTPUT_PAD_T;

typedef enum {
	PCB_AUDIO_OUPUT_TYPE_VOL,
	PCB_AUDIO_OUPUT_TYPE_FIXVOL,
	PCB_AUDIO_OUPUT_TYPE_BYPASS,
	PCB_AUDIO_OUPUT_TYPE_UNUSED,
} PCB_AUDIO_OUPUT_TYPE_T;
...
#define _AUDIO_MUX(sig, type, pad, pad_no)  \
		(((unsigned long long) (sig) & 0xFF) | (((unsigned long long) (type) & 0xFF) << 8) | (((unsigned long long) (pad) & 0xFF) << 16) | (((unsigned long long) (pad_no) & 0xFF) << 24))
