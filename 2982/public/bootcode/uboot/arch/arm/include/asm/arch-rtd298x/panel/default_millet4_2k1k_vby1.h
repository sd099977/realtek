...
#define CONFIG_DISPLAY_CLOCK_MAX 				310  // 150
#define CONFIG_DISPLAY_CLOCK_MIN 				230  // > 63M/port
#define CONFIG_DISPLAY_REFRESH_RATE 			60

#define CONFIG_DISPLAY_CLOCK_TYPICAL 			297*1000000
...
#define CONFIG_DISP_DEN_END_HPOS 				2160
...
//Off --> On Sequence
/////////////////////////////
#define PANEL_TO_LVDS_ON_ms     150      // Delay(T1+T2): Panel Power --> LVDS Signal T1+T2 <= 210ms
#define LVDS_TO_LIGHT_ON_ms     50     // Delay(T5): LVDS Signal --> Backlight On T5 >= 1500ms
/////////////////////////////
//On --> Off	Sequence
/////////////////////////////
...
//////////////////////////
#define CONFIG_DISPLAY_PORT_CONFIG1	0x01230123
#define CONFIG_DISPLAY_PORT_CONFIG2	0x01230123
...
#define CONFIG_SFG_PORT_NUM				4

#define CONFIG_PANEL_TYPE				P_VBY1_4K2K
#define CONFIG_PANEL_CUSTOM_INDEX		P_M4_Default_2k1k

#define CONFIG_PANEL_3D_TIMING 			_3D_TIMING_2K1K_120

///////////////////////////
// Panel Name
///////////////////////////
#define CONFIG_DISP_PANEL_NAME			"default_millet4_4k2k_by1.h"
