...
#ifndef SYS_PARAM_FACTORY_RO_START
#define CONFIG_FACTORY_RO_START	0x1000000	/* For eMMC */
#else
#define CONFIG_FACTORY_RO_START	SYS_PARAM_FACTORY_RO_START
#endif

#ifndef SYS_PARAM_FACTORY_RO_SIZE
#define CONFIG_FACTORY_RO_SIZE	0x200000		/* For eMMC */
#else
#define CONFIG_FACTORY_RO_SIZE	SYS_PARAM_FACTORY_RO_SIZE
#endif
...
#ifndef SYS_PARAM_FACTORY_RO_START
#define CONFIG_FACTORY_RO_START	0x3D00000	/* For NAND */
#else
#define CONFIG_FACTORY_RO_START	SYS_PARAM_FACTORY_RO_START
#endif

#ifndef SYS_PARAM_FACTORY_RO_SIZE
#define CONFIG_FACTORY_RO_SIZE	0x200000		/* For NAND */
#else
#define CONFIG_FACTORY_RO_SIZE	SYS_PARAM_FACTORY_RO_SIZE
#endif
...
#define FACTORY_RO_HDCP_2_2_BIN			FACTORY_RO_HEADER_FILE_NAME"hdcp2.2.bin"
...
#define FACTORY_RO_DTCP_BIN			FACTORY_RO_HEADER_FILE_NAME"dtcp.bin"
#define FACTORY_RO_CI_BIN			FACTORY_RO_HEADER_FILE_NAME"CI.bin"
#define FACTORY_RO_REE_BIN	        FACTORY_RO_HEADER_FILE_NAME"customerdata01.bin"
#define FACTORY_RO_TEE_BIN	        FACTORY_RO_HEADER_FILE_NAME"customerdata02.bin"
