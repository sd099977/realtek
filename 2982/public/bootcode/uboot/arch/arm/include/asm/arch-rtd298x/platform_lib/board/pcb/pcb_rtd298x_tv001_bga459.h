...
#define RTD298X_BGA459_PIN_C7								(0x0C&0x1F)//0xB806020C[26:22];
																							//0C: LSADC7,<AI>
...
#define AUDIO_OUTPUT_HEADPHONE_OUT	RTD299X_BGA_PIN_xx_3_VOL()
	...
	// SCART
#define PIN_SCART_FUNCTION_SELECT		RTD298X_BGA459_PIN_C7_LSADC_VOLTAGE_7(0, 5)
...
PCB_ENUM(POWER_EN)
PCB_ENUM(PIN_SCART_FUNCTION_SELECT)
