...
#define PPOVERLAY_IV2DV_DOUBLE_BUFFER_CTRL_VADDR   (0xb8028070)
...
typedef union
{
    ...
    struct{
        RBus_UInt32  res1:4;
        RBus_UInt32  outgamma_od_swap:1;
        RBus_UInt32  pcid_en:1;
        RBus_UInt32  shpnr_line_mode:2;
        RBus_UInt32  repeat_flag_mode:2;
        RBus_UInt32  res2:2;
        RBus_UInt32  d2tve_src_sel:2;
        RBus_UInt32  d2i3ddma_src_sel:2;
        RBus_UInt32  res3:1;
        RBus_UInt32  d2i3ddma_force_ctsfifo_rstn_i2:1;
        RBus_UInt32  d2i3ddma_en_ctsfifo_vsrst_i2:1;
        RBus_UInt32  d2i3ddma_en_ctsfifo_bypass_i2:1;
        RBus_UInt32  res4:1;
        RBus_UInt32  d2i3ddma_force_ctsfifo_rstn_i3:1;
        RBus_UInt32  d2i3ddma_en_ctsfifo_vsrst_i3:1;
        RBus_UInt32  d2i3ddma_en_ctsfifo_bypass_i3:1;
        RBus_UInt32  res5:4;
