...
#define RTD298X_QFP176_PIN_47								(0x0B&0x1F)//0xB8000830[22:18];
																							//00: nf_tmX_wr_n,<O>,<HS>
																							//01: SPI_DI,<I/O>,<HS>
																							//03: TCON_bit15,<O>
																							//09: ETN_LED_LINK,<O>
...
#define RTD298X_QFP176_PIN_48								(0x0D&0x1F)//0xB8000830[13:9];
...
#define RTD298X_QFP176_PIN_64								(0x09&0x1F)//0xB8000840[13:9];
...
#define RTD298X_QFP176_PIN_65								(0x09&0x1F)//0xB8000844[31:27];
...
#define PIN_BL_ON_OFF			RTD298X_QFP176_PIN_48_PWM_7(0, 20000, 255, 176)  //Power supply  and Backlight	
																				  //this name for can compile
#define PIN_2D_3D_SELECT		RTD298X_QFP176_PIN_90_GPO_83(0,0)
#define PIN_AMP_MUTE			RTD298X_QFP176_PIN_108_ISO_GPO_10(0,0)  // 0: mute  1: unmute
#define PIN_LED_RED_GREEN                 RTD298X_QFP176_PIN_123_ISO_GPO_0(0,1)  // 0:green   1: red
#define WIFI_POWER_SUPPLY			RTD298X_QFP176_PIN_129_ISO_GPO_47(0, 0)
...
PCB_ENUM(PIN_2D_3D_SELECT)
PCB_ENUM(WIFI_POWER_SUPPLY)
PCB_ENUM(PIN_LED_RED_GREEN)
