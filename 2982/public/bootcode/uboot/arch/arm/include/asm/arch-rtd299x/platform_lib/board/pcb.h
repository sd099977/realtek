...
#elif defined(CONFIG_BOARD_TV005_L4300_RTD2993_EMMC_V2)
	#include "pcb/pcb_rtd2993_tv005_l4300_v2.h"
#elif defined(CONFIG_BOARD_TV015_RTD299X_EMMC)
	#include "pcb/pcb_rtd299x_tv015.h"
...
#elif defined(CONFIG_BOARD_TV013_RTD2992_EMMC)
	#include "pcb/pcb_rtd2992_tv013_v1.h"	
#else
