...
#define RTD298X_BGA459_PIN_Y19								(0x01&0x1F)//0xB8000830[31:27];
																							//00: nf_tmX_cle,<O>,<HS>
																							//01: SPI_SCLK,<O>,<HS>
																							//02: EMMC_CLK,<O>,<HS>
																							//03: TCON_bit14,<O>
...
#define RTD298X_BGA459_PIN_Y19_UP							(1&0x01)// 0xB8000830[26]: Pull Up 0:disable 1:enable
...
#define RTD298X_BGA459_PIN_AB19								(0x01&0x1F)//0xB8000830[22:18];
																							//00: nf_tmX_wr_n,<O>,<HS>
																							//01: SPI_DI,<I/O>,<HS>
																							//03: TCON_bit15,<O>
																							//09: ETN_LED_LINK,<O>
...
#define RTD298X_BGA459_PIN_AB19_UP							(1&0x01)// 0xB8000830[17]: Pull Up 0:disable 1:enable
...
#define RTD298X_BGA459_PIN_AE20								(0x01&0x1F)//0xB8000830[13:9];
...
#define RTD298X_BGA459_PIN_AA19								(0x01&0x1F)//0xB8000834[31:27];
																							//00: nf_tmX_ale,<O>,<HS>
																							//01: SPI_DO,<I/O>,<HS>
																							//03: TCON_bit17,<O>
...
#define RTD298X_BGA459_PIN_AA19_UP							(1&0x01)// 0xB8000834[26]: Pull Up 0:disable 1:enable
...
#define RTD298X_BGA459_PIN_AC14								(0x01&0x1F)//0xB8000834[13:9];
...
#define RTD298X_BGA459_PIN_AC14_UP							(1&0x01)// 0xB8000834[8]: Pull Up 0:disable 1:enable
...
#define RTD298X_BGA459_PIN_AC12								(0x01&0x1F)//0xB8000838[31:27];
...
#define RTD298X_BGA459_PIN_AC12_UP							(1&0x01)// 0xB8000838[26]: Pull Up 0:disable 1:enable
...
#define RTD298X_BGA459_PIN_AE16								(0x01&0x1F)//0xB8000838[22:18];
...
#define RTD298X_BGA459_PIN_AE16_UP							(1&0x01)// 0xB8000838[17]: Pull Up 0:disable 1:enable
...
#define RTD298X_BGA459_PIN_AD17								(0x01&0x1F)//0xB8000838[13:9];
...
#define RTD298X_BGA459_PIN_AD17_UP							(1&0x01)// 0xB8000838[8]: Pull Up 0:disable 1:enable
...
#define RTD298X_BGA459_PIN_AE17								(0x01&0x1F)//0xB800083C[31:27];
...
#define RTD298X_BGA459_PIN_AE17_UP							(1&0x01)// 0xB800083C[26]: Pull Up 0:disable 1:enable
...
#define RTD298X_BGA459_PIN_AC16								(0x01&0x1F)//0xB800083C[22:18];
...
#define RTD298X_BGA459_PIN_AC16_UP							(1&0x01)// 0xB800083C[17]: Pull Up 0:disable 1:enable
...
#define RTD298X_BGA459_PIN_AC18								(0x01&0x1F)//0xB800083C[13:9];
...
#define RTD298X_BGA459_PIN_AC18_UP							(1&0x01)// 0xB800083C[8]: Pull Up 0:disable 1:enable
...
#define RTD298X_BGA459_PIN_AD18								(0x01&0x1F)//0xB8000840[31:27];
...
#define RTD298X_BGA459_PIN_AD18_UP							(1&0x01)// 0xB8000840[26]: Pull Up 0:disable 1:enable
...
#define RTD298X_BGA459_PIN_AC19_UP							(1&0x01)// 0xB8000840[17]: Pull Up 0:disable 1:enable
...
#define RTD298X_BGA459_PIN_AE19_UP							(1&0x01)// 0xB8000844[8]: Pull Up 0:disable 1:enable
...
#define RTD298X_BGA459_PIN_AD16								(0x15&0x1F)//0xB8000950[31:27];
																							//15: PCMCIA_ADDR_bit7,<OD>,<HS>
...
//#define PIN_KEYPAD_MENU		RTD298X_BGA459_PIN_B7_LSADC_CURRENT_0(19, 1)
//#define PIN_KEYPAD_SOURCE		RTD298X_BGA459_PIN_B7_LSADC_CURRENT_0(14, 1)
//#define PIN_KEYPAD_RIGHT		RTD298X_BGA459_PIN_C6_LSADC_VOLTAGE_1(0, 10)
//#define PIN_KEYPAD_LEFT		RTD298X_BGA459_PIN_C6_LSADC_VOLTAGE_1(58, 10)
//#define PIN_KEYPAD_UP			RTD298X_BGA459_PIN_C6_LSADC_VOLTAGE_1(125, 10)
//#define PIN_KEYPAD_DOWN		RTD298X_BGA459_PIN_C6_LSADC_VOLTAGE_1(192, 10)
//#define PIN_KEYPAD_PWR		RTD298X_BGA459_PIN_C6_LSADC_CURRENT_1(0, 10)
...
//#define I2C_PORT_2                      PCB_HW_I2C(PCB_I2C_PHY_2, PCB_I2C_SUB_SRC_ANY)
	...
	//I2C Port 2:GPIO I2C, SDA=GPIO 35, SCL=GPIO 25 //for control tcon vby i2c
#define PIN_I2C2_SDA                   RTD298X_BGA459_PIN_E7_GPO_35(0,0)
#define PIN_I2C2_SCL                   RTD298X_BGA459_PIN_E8_GPO_25(0,0)
#define I2C_PORT_2                      PCB_GPIO_I2C(PIN_I2C2_SDA, PIN_I2C2_SCL)
...
#define PIN_RED_LED				RTD298X_BGA459_PIN_F8_ISO_GPO_37(0,1)  //
#define PIN_GREEN_LED			RTD298X_BGA459_PIN_D7_ISO_GPO_0(0,1)  //
#define PIN_3D_PWM				RTD298X_BGA459_PIN_F25_PWM_1(1, 200, 200, 200)
...
#define PIN_PCMCIA_EN			RTD298X_BGA459_PIN_B14_GPO_96(0, 1)
	// USB hub Reset ?
	//#define HUB_RET
...
#define AV1_VGND	VIDEO_GNDA0
	...
	//Millet3
#define MILLET3_DEVICE_ADDR			0x1c
#define MILLET3_I2C						PCB_I2C_2
