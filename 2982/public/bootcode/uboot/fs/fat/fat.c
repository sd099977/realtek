		...
		for (i = 0; i < DIRENTSPERBLOCK; i++) {
				...
				if ((dentptr->attr & ATTR_VFAT) == ATTR_VFAT &&
					...
					if (dols == LS_ROOT) {
						...
						if (file_count) {
                                                        ...
                                                        // long name ...
                                                        if (!isdir && files) {
                                                            if (strncmp(l_name, "skyworth_test_", strlen("skyworth_test_")) == 0) { //customer special pattern
                                                                memset(fat_ls_first_name, 0, sizeof(fat_ls_first_name));
			...
			if (dols == LS_ROOT) {
				...
				if (file_count) {
                                        ...
                                        //// short name no need to compare with skyworth_test...
                                        //if (!isdir && files) {
                                        //    if (strncmp(s_name, "skyworth_test_", strlen("skyworth_test_")) == 0) { //customer special pattern
                                        //        memset(fat_ls_first_name, 0, sizeof(fat_ls_first_name));
