...
#ifdef DEBUG
#define FAT_DPRINT(args...)	printk(args)
#else
#define FAT_DPRINT(args...)
#endif
#define FAT_ERROR(arg)		printk(arg)
...
} boot_sector; // __attribute__ ((aligned (512)));
...
} volume_info; // __attribute__ ((aligned (512)));
...
} dir_entry; // __attribute__ ((aligned (512)));
...
} dir_slot; // __attribute__ ((aligned (512)));
...
} fsdata; // __attribute__ ((aligned (512)));
