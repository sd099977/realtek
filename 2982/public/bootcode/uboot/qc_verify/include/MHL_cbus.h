...
#define _NULL_POINTER                            (UINT8 *)0xFFFFFFFF
//**********************************************************************
...
//--------------------------------------------------
//  MHL CDF Cability Setting
//--------------------------------------------------
#define CDF_CR_MHL_VER_MAJOR     	 2
#define CDF_CR_MHL_VER_MINOR     	 1
...
#define CDF_CR_LD_SPEAKER          	0   // for cts no support RCP command 
...
#define FW0Requester_set_req_en(x)	   		rtd_maskl(FW0_REQ_00_reg,~(FW0_REQ_00_fw0_req_mask|FW0_REQ_00_fw0_fifo_clr_mask),(FW0_REQ_00_fw0_req(x))|(FW0_REQ_00_fw0_fifo_clr(0)))
#define FW0Requester_set_tx_case(x)	   		rtd_maskl(FW0_REQ_00_reg,~(FW0_REQ_00_fw0_tx_case_mask|FW0_REQ_00_fw0_fifo_clr_mask),(FW0_REQ_00_fw0_tx_case(x))|(FW0_REQ_00_fw0_fifo_clr(0)))
#define FW0Requester_set_head(x)	   		rtd_maskl(FW0_REQ_00_reg,~(FW0_REQ_00_fw0_head_mask|FW0_REQ_00_fw0_fifo_clr_mask),(FW0_REQ_00_fw0_head(x))|(FW0_REQ_00_fw0_fifo_clr(0)))
#define FW0Requester_set_cmd1(x)	   		rtd_maskl(FW0_REQ_01_reg,~(FW0_REQ_01_fw0_cmd1_mask),FW0_REQ_01_fw0_cmd1(x))
#define FW0Requester_set_cmd2(x)	   		rtd_maskl(FW0_REQ_02_reg,~(FW0_REQ_02_fw0_cmd2_mask),FW0_REQ_02_fw0_cmd2(x))
#define FW0Requester_set_offset(x)	   		rtd_maskl(FW0_REQ_03_reg,~(FW0_REQ_03_fw0_offset_mask),FW0_REQ_03_fw0_offset(x))
#define FW0Requester_set_data(x)	   		rtd_maskl(FW0_REQ_04_reg,~(FW0_REQ_04_fw0_data_mask),FW0_REQ_04_fw0_data(x))
#define FW0Requester_set_wait_case(x)	   	rtd_maskl(FW0_REQ_05_reg,~(FW0_REQ_05_fw0_wait_case_mask),FW0_REQ_05_fw0_wait_case(x))
#define FW0Requester_set_cmd_flag(x)	   	rtd_maskl(FW0_REQ_05_reg,~(FW0_REQ_05_fw0_cmd_irq_en_mask),FW0_REQ_05_fw0_cmd_event(x))
#define FW0Requester_set_data_flag(x)	   	rtd_maskl(FW0_REQ_05_reg,~(FW0_REQ_05_fw0_data_irq_en_mask),FW0_REQ_05_fw0_data_event(x))
#define FW0Requester_set_finish_flag(x)   	       rtd_maskl(FW0_REQ_05_reg,~(FW0_REQ_05_fw0_fin_mask),FW0_REQ_05_fw0_fin(x))
#define FW0Requester_set_error_flag(x)   	       rtd_maskl(FW0_REQ_05_reg,~(FW0_REQ_05_fw0_rcv_err_mask),FW0_REQ_05_fw0_rcv_err(x))

#define FW0Requester_CLR_error_code()   	       rtd_maskl(CBUS_MSC_0A_reg,~(CBUS_MSC_0A_msc_err_code_mask),CBUS_MSC_0A_msc_err_code_mask)

#define FW0Requester_get_finish_flag()   	       FW0_REQ_05_get_fw0_fin(rtd_inl(FW0_REQ_05_reg))
#define FW0Requester_get_error_flag()   	       FW0_REQ_05_get_fw0_rcv_err(rtd_inl(FW0_REQ_05_reg))
#define FW0Requester_get_cmd_flag()   	       FW0_REQ_05_get_fw0_cmd_event(rtd_inl(FW0_REQ_05_reg))
#define FW0Requester_get_data_flag()   	       FW0_REQ_05_get_fw0_data_event(rtd_inl(FW0_REQ_05_reg))
#define FW0Requester_get_cmd()   	       	FW0_REQ_06_get_fw0_cmd_rcv(rtd_inl(FW0_REQ_06_reg))
#define FW0Requester_get_data()   	       	FW0_REQ_07_get_fw0_data_rcv(rtd_inl(FW0_REQ_07_reg))
#define FW0Requester_get_error_code()   	       CBUS_MSC_0A_get_msc_err_code(rtd_inl(CBUS_MSC_0A_reg))
