...
#define SYSTEM_ST_MHL_CBUS_VADDR                  (0xb8060048)
...
#define SYSTEM_SOFT_RESET1_VADDR                  (0xb8000000)
#define SYSTEM_SOFT_RESET2_VADDR                  (0xb8000004)
#define SYSTEM_SOFT_RESET3_VADDR                  (0xb8000008)
#define SYSTEM_CLOCK_ENABLE1_VADDR                (0xb800000c)
#define SYSTEM_CLOCK_ENABLE2_VADDR                (0xb8000010)
#define SYSTEM_GROUP1_CK_EN_VADDR                 (0xb8000014)
#define SYSTEM_GROUP1_CK_SEL_VADDR                (0xb8000018)
#define SYSTEM_TVE_CK_SEL_VADDR                   (0xb800001c)
#define SYSTEM_DISP_PLL_DIV_VADDR                 (0xb8000020)
#define SYSTEM_DISP_PLL_DIV2_VADDR                (0xb8000024)
#define SYSTEM_DISP_PLL_DIV3_VADDR                (0xb8000028)
#define SYSTEM_AUDIO_CLK_CTL_VADDR                (0xb800002c)
#define SYSTEM_PLL_DIV_VADDR                      (0xb8000030)
#define SYSTEM_NF_CKSEL_VADDR                     (0xb8000038)
#define SYSTEM_NDS_SC_CKSEL_VADDR                 (0xb800003c)
#define SYSTEM_CR_CKSEL_VADDR                     (0xb8000040)
#define SYSTEM_CLKDIV_VADDR                       (0xb8000044)
#define SYSTEM_ARM_WD_VADDR                       (0xb8000048)
#define SYSTEM_POWER_CTRL0_VADDR                  (0xb800004c)
#define SYSTEM_PLL_WDOUT_VADDR                    (0xb8000050)
#define SYSTEM_TM_CTRL0_VADDR                     (0xb8000054)
#define SYSTEM_TM_CTRL1_VADDR                     (0xb8000058)
#define SYSTEM_TM_CTRL2_VADDR                     (0xb800005c)
#define SYSTEM_DSS00_DSS_GPU0_VADDR               (0xb8000060)
#define SYSTEM_DSS01_DSS_GPU0_VADDR               (0xb8000064)
#define SYSTEM_DSS02_DSS_GPU0_VADDR               (0xb8000068)
#define SYSTEM_DSS03_DSS_GPU1_VADDR               (0xb800006c)
#define SYSTEM_DSS04_DSS_GPU1_VADDR               (0xb8000070)
#define SYSTEM_DSS05_DSS_GPU1_VADDR               (0xb8000074)
#define SYSTEM_DSS06_DSS_GPU2_VADDR               (0xb8000078)
#define SYSTEM_DSS07_DSS_GPU2_VADDR               (0xb800007c)
#define SYSTEM_DSS08_DSS_GPU2_VADDR               (0xb8000080)
#define SYSTEM_DSS09_DSS_GPU3_VADDR               (0xb8000084)
#define SYSTEM_DSS10_DSS_GPU3_VADDR               (0xb8000088)
#define SYSTEM_DSS11_DSS_GPU3_VADDR               (0xb800008c)
#define SYSTEM_DSS12_DSS_TOP0_VADDR               (0xb8000090)
#define SYSTEM_DSS13_DSS_TOP0_VADDR               (0xb8000094)
#define SYSTEM_DSS14_DSS_TOP0_VADDR               (0xb8000098)
#define SYSTEM_DSS15_DSS_TVSB10_VADDR             (0xb800009c)
#define SYSTEM_DSS16_DSS_TVSB10_VADDR             (0xb80000a0)
#define SYSTEM_DSS17_DSS_TVSB10_VADDR             (0xb80000a4)
#define SYSTEM_DSS18_DSS_TVSB11_VADDR             (0xb80000a8)
#define SYSTEM_DSS19_DSS_TVSB11_VADDR             (0xb80000ac)
#define SYSTEM_DSS20_DSS_TVSB11_VADDR             (0xb80000b0)
#define SYSTEM_DSS21_DSS_TVSB30_VADDR             (0xb80000b4)
#define SYSTEM_DSS22_DSS_TVSB30_VADDR             (0xb80000b8)
#define SYSTEM_DSS23_DSS_TVSB30_VADDR             (0xb80000bc)
#define SYSTEM_CSM00_CSM_DDR_VADDR                (0xb80007e8)
#define SYSTEM_CSM01_CSM_DDR_VADDR                (0xb80007ec)
#define SYSTEM_CSM02_CSM_DDR_VADDR                (0xb80007f0)
#define SYSTEM_CSM03_CSM_DDR_VADDR                (0xb80007f4)
#define SYSTEM_CSM04_CSM_DDR_VADDR                (0xb80007f8)
#define SYSTEM_CSM05_CSM_DDR_VADDR                (0xb80007fc)
#define SYSTEM_CHIP_SRAM_CTRL_VADDR               (0xb80000c0)
#define SYSTEM_CHIP_MISC_CTRL_VADDR               (0xb80000c4)
#define SYSTEM_CHIP_INFO2_VADDR                   (0xb80000c8)
#define SYSTEM_APS_CTL_VADDR                      (0xb80000cc)
#define SYSTEM_PWDN_CTRL_VADDR                    (0xb80000d0)
#define SYSTEM_PWDN_CTRL2_VADDR                   (0xb80000d4)
#define SYSTEM_PWDN_CTRL3_VADDR                   (0xb80000d8)
#define SYSTEM_PWDN_CTRL4_VADDR                   (0xb80000dc)
#define SYSTEM_AT_SPEED_VADDR                     (0xb80000e0)
#define SYSTEM_ANA_CTRL_VADDR                     (0xb80000e4)
#define SYSTEM_TP_DEMOD_CTRL_VADDR                (0xb80000e8)
#define SYSTEM_CONTROL0_VADDR                     (0xb80000ec)
#define SYSTEM_SECURITY_ST_VADDR                  (0xb80000f0)
#define SYSTEM_DMY2_VADDR                         (0xb80000f4)
#define SYSTEM_BUS_PLL_SSC_VADDR                  (0xb80000f8)
#define SYSTEM_DCSB_PLL_SSC_VADDR                 (0xb80000fc)
#define SYSTEM_PLL_SCPU1_VADDR                    (0xb8000100)
#define SYSTEM_PLL_SCPU2_VADDR                    (0xb8000104)
#define SYSTEM_PLL_ACPU1_VADDR                    (0xb8000108)
#define SYSTEM_PLL_ACPU2_VADDR                    (0xb800010c)
#define SYSTEM_PLL_VCPU1_VADDR                    (0xb8000110)
#define SYSTEM_PLL_VCPU2_VADDR                    (0xb8000114)
#define SYSTEM_PLL_BUS1_VADDR                     (0xb8000130)
#define SYSTEM_PLL_BUS2_VADDR                     (0xb8000134)
#define SYSTEM_PLL_BUS3_VADDR                     (0xb8000138)
#define SYSTEM_PLL_DCSB1_VADDR                    (0xb8000140)
#define SYSTEM_PLL_DCSB2_VADDR                    (0xb8000144)
#define SYSTEM_PLL_DCSB3_VADDR                    (0xb8000148)
#define SYSTEM_PLL_VODMA1_VADDR                   (0xb8000160)
#define SYSTEM_PLL_VODMA2_VADDR                   (0xb8000164)
#define SYSTEM_PLLBUS_TST_VADDR                   (0xb8000168)
#define SYSTEM_PLL_DISP_SD1_VADDR                 (0xb8000170)
#define SYSTEM_PLL_DISP_SD2_VADDR                 (0xb8000174)
#define SYSTEM_PLL_DISP_SD3_VADDR                 (0xb8000178)
#define SYSTEM_PLL_DISP_SD4_VADDR                 (0xb800017c)
#define SYSTEM_PLL_DISP_SD5_VADDR                 (0xb8000180)
#define SYSTEM_PLL_DISP_SD6_VADDR                 (0xb8000184)
#define SYSTEM_PLL_DISP_SD7_VADDR                 (0xb8000188)
#define SYSTEM_PLL_DISP1_VADDR                    (0xb8000190)
#define SYSTEM_PLL_DISP2_VADDR                    (0xb8000194)
#define SYSTEM_PLL_VBY1_MAC1_VADDR                (0xb8000198)
#define SYSTEM_TMDS_SCR1_VADDR                    (0xb80001c0)
#define SYSTEM_TMDS_SCR2_VADDR                    (0xb80001c4)
#define SYSTEM_TMDS_SCR3_VADDR                    (0xb80001c8)
#define SYSTEM_TVPLL_CTRL1_VADDR                  (0xb80001cc)
#define SYSTEM_TVPLL_CTRL2_VADDR                  (0xb80001d0)
#define SYSTEM_TVPLL_CTRL3_VADDR                  (0xb80001d4)
#define SYSTEM_TVPLL_CTRL4_VADDR                  (0xb80001d8)
#define SYSTEM_TVPLL_CTRL5_VADDR                  (0xb80001dc)
#define SYSTEM_TVPLL_CTRL6_VADDR                  (0xb80001f0)
#define SYSTEM_PLL_GPU1_VADDR                     (0xb80001e0)
#define SYSTEM_PLL_GPU2_VADDR                     (0xb80001e4)
#define SYSTEM_PLL_GPU3_VADDR                     (0xb80001e8)
#define SYSTEM_PLL_GPU4_VADDR                     (0xb80001ec)
#define SYSTEM_TRNG1_VADDR                        (0xb80001fc)
#define SYSTEM_CRT_DEBUG_VADDR                    (0xb8000400)
#define SYSTEM_DUMMY_VADDR                        (0xb8000450)
#define SYSTEM_CRT_BIST_EN1_VADDR                 (0xb8000500)
#define SYSTEM_CRT_BIST_EN2_VADDR                 (0xb8000504)
#define SYSTEM_CRT_BIST_EN3_VADDR                 (0xb8000508)
#define SYSTEM_CRT_DRF_BIST_EN1_VADDR             (0xb8000520)
#define SYSTEM_CRT_DRF_BIST_EN2_VADDR             (0xb8000524)
#define SYSTEM_CRT_DRF_BIST_EN3_VADDR             (0xb8000528)
#define SYSTEM_CRT_DRF_TEST_RESUME1_VADDR         (0xb8000540)
#define SYSTEM_CRT_DRF_TEST_RESUME2_VADDR         (0xb8000544)
#define SYSTEM_CRT_DRF_TEST_RESUME3_VADDR         (0xb8000548)
#define SYSTEM_CRT_DRF_START_PAUSE1_VADDR         (0xb8000560)
#define SYSTEM_CRT_DRF_START_PAUSE3_VADDR         (0xb8000568)
#define SYSTEM_CRT_BISR_EN1_VADDR                 (0xb8000580)
#define SYSTEM_CRT_BISR_RSTN1_VADDR               (0xb8000588)
#define SYSTEM_CRT_BISR_PWR_RSTN1_VADDR           (0xb8000590)
#define SYSTEM_CRT_BISR_HOLD_REMAP1_VADDR         (0xb8000598)
#define SYSTEM_CRT_BISR_HOLD_REMAP2_VADDR         (0xb800059c)
#define SYSTEM_CRT_BISR_2ND_RUN_EN1_VADDR         (0xb80005a0)
#define SYSTEM_CRT_DRF_BISR_EN1_VADDR             (0xb80005a8)
#define SYSTEM_CRT_DRF_BISR_TEST_RESUME1_VADDR    (0xb80005b0)
#define SYSTEM_CRT_SLEEP_ACK1_VADDR               (0xb80005b4)
#define SYSTEM_CRT_SLEEP_REQ1_VADDR               (0xb80005b8)
#define SYSTEM_CRT_LIGHT_SLEEP1_VADDR             (0xb80005c0)
#define SYSTEM_CRT_BISR_RSTN2_VADDR               (0xb80005d0)
#define SYSTEM_BIST_ST1_VADDR                     (0xb8000600)
#define SYSTEM_BIST_ST2_VADDR                     (0xb8000610)
#define SYSTEM_BIST_ST3_VADDR                     (0xb8000614)
#define SYSTEM_DRF_ST1_VADDR                      (0xb8000620)
#define SYSTEM_DRF_ST2_VADDR                      (0xb8000624)
#define SYSTEM_CRT_BISR_DONE1_VADDR               (0xb8000700)
#define SYSTEM_CRT_BISR_ST1_VADDR                 (0xb8000710)
#define SYSTEM_CRT_BISR_REPAIRED1_VADDR           (0xb8000720)
#define SYSTEM_CRT_BISR_OUT1_VADDR                (0xb8000730)
#define SYSTEM_CRT_BISR_OUT2_VADDR                (0xb8000734)
#define SYSTEM_CRT_DRF_BISR_ST1_VADDR             (0xb8000750)
#define SYSTEM_SYS_PLL_512FS1_VADDR               (0xb8000200)
#define SYSTEM_SYS_PLL_512FS2_VADDR               (0xb8000204)
#define SYSTEM_SYS_PLL_DIF1_VADDR                 (0xb8000220)
#define SYSTEM_SYS_PLL_DIF2_VADDR                 (0xb8000224)
#define SYSTEM_SYS_PLL_DIF3_VADDR                 (0xb8000228)
#define SYSTEM_SYS_PLL_27X1_VADDR                 (0xb8000240)
#define SYSTEM_SYS_PLL_27X2_VADDR                 (0xb8000244)
#define SYSTEM_SYS_PLL_27X3_VADDR                 (0xb8000248)
#define SYSTEM_SYS_PLL_27X4_VADDR                 (0xb800024c)
#define SYSTEM_SYS_PLL_AUD1_VADDR                 (0xb8000260)
#define SYSTEM_SYS_PLL_AUD3_VADDR                 (0xb8000264)
#define SYSTEM_SYS_PLL_PSAUD1_VADDR               (0xb8000280)
#define SYSTEM_SYS_PLL_PSAUD2_VADDR               (0xb8000284)
#define SYSTEM_SYS_PLL_DDR1_VADDR                 (0xb80002c0)
#define SYSTEM_SYS_PLL_DDR2_VADDR                 (0xb80002c4)
#define SYSTEM_SYS_PLL_DDR3_VADDR                 (0xb80002c8)
#define SYSTEM_SYS_PLL_DDR4_VADDR                 (0xb80002cc)
#define SYSTEM_SYS_PLL_DDR_SSC1_VADDR             (0xb80002d0)
#define SYSTEM_SYS_PLL_DDR_SSC2_VADDR             (0xb80002d4)
#define SYSTEM_SYS_PLL_DDR_SSC3_VADDR             (0xb80002d8)
#define SYSTEM_SYS_PLL_DDR5_VADDR                 (0xb80002dc)
#define SYSTEM_SYS_PLL_DDR5_1_VADDR               (0xb80002e0)
#define SYSTEM_SYS_PLL_DUMMY_IN_VADDR             (0xb80002e4)
#define SYSTEM_SYS_PLL_DUMMY_OUT_VADDR            (0xb80002e8)
#define SYSTEM_SYS_DCLKSS_VADDR                   (0xb8000300)
#define SYSTEM_DPLL_IN_FSYNC_TRACKING_CTRL_VADDR  (0xb8000304)
#define SYSTEM_DPLL_IN_FSYNC_TRACKING_CTRL2_VADDR (0xb8000308)
#define SYSTEM_DPLL_IN_FSYNC_TRACKING_DEBUG_VADDR (0xb800030c)
#define SYSTEM_DCLK_FRC2FSYNC_SPEEDUP_VADDR       (0xb8000310)
#define SYSTEM_DPLL_STATUS_RO_VADDR               (0xb8000314)
#define SYSTEM_DCLKSS_FREQ_VADDR                  (0xb8000318)
#define SYSTEM_DCLKSS_PROFILE0_VADDR              (0xb800031c)
#define SYSTEM_DCLKSS_PROFILE1_VADDR              (0xb8000320)
#define SYSTEM_DCLKSS_PROFILE2_VADDR              (0xb8000324)
#define SYSTEM_DCLKSS_PROFILE3_VADDR              (0xb8000328)
#define SYSTEM_DCLKSS_PROFILE4_VADDR              (0xb800032c)
#define SYSTEM_DCLKSS_PROFILE5_VADDR              (0xb8000330)
#define SYSTEM_DCLKSS_PROFILE6_VADDR              (0xb8000334)
#define SYSTEM_DCLKSS_PROFILE7_VADDR              (0xb8000338)
#define SYSTEM_DCLKSS_PROFILE8_VADDR              (0xb800033c)
#define SYSTEM_DCLKSS_PROFILE9_VADDR              (0xb8000340)
#define SYSTEM_DCLKSS_PROFILE10_VADDR             (0xb8000344)
#define SYSTEM_DCLKSS_PROFILE11_VADDR             (0xb8000348)
#define SYSTEM_DCLKSS_PROFILE12_VADDR             (0xb800034c)
#define SYSTEM_DCLKSS_PROFILE13_VADDR             (0xb8000350)
#define SYSTEM_DCLKSS_PROFILE14_VADDR             (0xb8000354)
#define SYSTEM_DCLKSS_PROFILE15_VADDR             (0xb8000358)
#define SYSTEM_DPLL_DOUBLE_BUFFER_CTRL_VADDR      (0xb800035c)
