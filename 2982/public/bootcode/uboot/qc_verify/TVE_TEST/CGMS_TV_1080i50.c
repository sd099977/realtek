//############################################################################################################
//
// File Name: TV_1080i50.c
// Description: TV Encoder 1080i/50Hz initial setting
...
//                     TVE_DAC_MUX_write_en4(1)|TVE_DAC_MUX_up_ctrl_int1(1)|
    ...
    rtd_outl(TVE_SYNCGEN_P_reg,
                     ...
                     TVE_SYNCGEN_P_write_en1(1)|TVE_SYNCGEN_P_h_thr(1319));
    //0xb801800c
    rtd_outl(TVE_SYNCGEN_HDMI_reg,
                     ...
                     TVE_SYNCGEN_HDMI_write_en1(1)|TVE_SYNCGEN_HDMI_h_thr(1319));
    ...
    rtd_outl(TVE_COMP_SER_HPOS_reg,
                     TVE_COMP_SER_HPOS_write_en2(1)|TVE_COMP_SER_HPOS_ser_hstart(200)|
                     TVE_COMP_SER_HPOS_write_en1(1)|TVE_COMP_SER_HPOS_ser_hend(1078));
    //0xb801808c
...
*/
    ...
    rtd_outl(TVE_AV_COEFF3_reg,
                     ...
                     TVE_AV_COEFF3_write_en1(1)|TVE_AV_COEFF3_c6(0x13ff));
    //0xb8018114
    rtd_outl(TVE_AV_COEFF4_reg,
                     TVE_AV_COEFF4_write_en2(1)|TVE_AV_COEFF4_k1(0xd4a)|
                     TVE_AV_COEFF4_write_en1(1)|TVE_AV_COEFF4_k2(0xc4f));
    //0xb8018118
    rtd_outl(TVE_AV_COEFF5_reg,
                     TVE_AV_COEFF5_write_en1(1)|TVE_AV_COEFF5_vbi_gain_ebl(0)|
