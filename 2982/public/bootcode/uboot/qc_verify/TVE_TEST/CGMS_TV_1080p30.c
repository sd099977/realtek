//############################################################################################################
//
// File Name: TV_1080p30.c
// Description: TV Encoder 1080p/30Hz initial setting
// Parameter:
...
//                     TVE_AV_CTRL_write_data(0));
    ...
    rtd_outl(TVE_P_COLORBAR_HPOS_reg,
                     ...
                     TVE_P_COLORBAR_HPOS_write_en1(1)|TVE_P_COLORBAR_HPOS_p_h_st_pos(273));
    //0xb801807c
    rtd_outl(TVE_H_COLORBAR_HPOS_reg,
                     TVE_H_COLORBAR_HPOS_write_en2(1)|TVE_H_COLORBAR_HPOS_p_h_width(239)|
                     TVE_H_COLORBAR_HPOS_write_en1(1)|TVE_H_COLORBAR_HPOS_p_h_st_pos(273));
    ...
    rtd_outl(TVE_COMP_VSYNC_HPOS_reg,
                     TVE_COMP_VSYNC_HPOS_write_en3(1)|TVE_COMP_VSYNC_HPOS_negsyncst(42)|
