//############################################################################################################
//
// File Name: TV_1080p50.c
// Description: TV Encoder 1080p/50Hz initial setting
// Parameter:
//
...
void TVE_TV_1080p50(void)
{
    ...
    rtd_outl(TVE_SYNCGEN_P_reg,
                     ...
                     TVE_SYNCGEN_P_write_en1(1)|TVE_SYNCGEN_P_h_thr(2639));
    //0xb801800c
    rtd_outl(TVE_SYNCGEN_HDMI_reg,
                     ...
                     TVE_SYNCGEN_HDMI_write_en1(1)|TVE_SYNCGEN_HDMI_h_thr(2639));
    ...
    rtd_outl(TVE_AV_P_HPOS1_reg,
                     ...
                     TVE_AV_P_HPOS1_write_en2(1)|TVE_AV_P_HPOS1_p_h_st(309)|
                     TVE_AV_P_HPOS1_write_en1(1)|TVE_AV_P_HPOS1_p_h_end(2229));
    //0xb8018064
    ...
    rtd_outl(TVE_AV_H_HPOS1_reg,
                     ...
                     TVE_AV_H_HPOS1_write_en2(1)|TVE_AV_H_HPOS1_h_h_st(309)|
                     TVE_AV_H_HPOS1_write_en1(1)|TVE_AV_H_HPOS1_h_h_end(2229));
    //0xb801806c
    ...
    rtd_outl(TVE_P_COLORBAR_HPOS_reg,
                     ...
                     TVE_P_COLORBAR_HPOS_write_en1(1)|TVE_P_COLORBAR_HPOS_p_h_st_pos(307));
    //0xb801807c
    rtd_outl(TVE_H_COLORBAR_HPOS_reg,
                     TVE_H_COLORBAR_HPOS_write_en2(1)|TVE_H_COLORBAR_HPOS_p_h_width(239)|
                     TVE_H_COLORBAR_HPOS_write_en1(1)|TVE_H_COLORBAR_HPOS_p_h_st_pos(307));
    ...
    rtd_outl(TVE_COMP_VSYNC_HPOS_reg,
                     TVE_COMP_VSYNC_HPOS_write_en3(1)|TVE_COMP_VSYNC_HPOS_negsyncst(77)|
                     TVE_COMP_VSYNC_HPOS_write_en2(1)|TVE_COMP_VSYNC_HPOS_possyncst(121)|
                     TVE_COMP_VSYNC_HPOS_write_en1(1)|TVE_COMP_VSYNC_HPOS_syncend(165));
    //0xb8018088
    rtd_outl(TVE_COMP_SER_HPOS_reg,
                     TVE_COMP_SER_HPOS_write_en2(1)|TVE_COMP_SER_HPOS_ser_hstart(253)|
                     TVE_COMP_SER_HPOS_write_en1(1)|TVE_COMP_SER_HPOS_ser_hend(2233));
    //0xb801808c
    ...
    rtd_outl(TVE_AV_COEFF3_reg,
                     ...
                     TVE_AV_COEFF3_write_en1(1)|TVE_AV_COEFF3_c6(0x1450));
    //0xb8018114
    ...
    rtd_outl(TVE_AV_COEFF5_reg,
                     ...
                     TVE_AV_COEFF5_write_en2(1)|TVE_AV_COEFF5_k3(0xbba));
