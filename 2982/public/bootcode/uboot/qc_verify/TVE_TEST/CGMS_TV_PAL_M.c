//#######################################################################################################
//
//  File Name:      TV_PAL_M.C
//  Description:    PAL-M initial setting
//
//#######################################################################################################
#include "TVE_reg.h"
#include "qc_verify.h"
...
void TVE_TV_PAL_M(UINT32 colorbar)
{
    ...
    //0xb8018880
	rtd_outl(TVE_IP_PHS_0_reg, TVE_IP_PHS_phi(0xa3));
	//0xb8018884 
	rtd_outl(TVE_IP_PHS_1_reg, TVE_IP_PHS_phi(0xef));
	//0xb8018888 
	rtd_outl(TVE_IP_PHS_2_reg, TVE_IP_PHS_phi(0xe6));
	//0xb801888c 
	...
	// 0xb80180b4
	rtd_outl(TVE_IP_HSYNCPOS_reg, TVE_IP_HSYNCPOS_hthr(793));
	...
	rtd_outl(TVE_AV_I_HPOS_reg,
					 ...
					 TVE_AV_I_HPOS_write_en1(1)|TVE_AV_I_HPOS_i_h_end(787));
