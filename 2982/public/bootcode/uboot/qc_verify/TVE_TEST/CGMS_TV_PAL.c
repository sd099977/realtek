...
//
// File Name: TV_PAL.c
// Description: TV Encoder PAL for CVBS initial setting
// Parameter:
...
void TVE_TV_PAL(void)
{
    ...
    //Y gain--------------------------------------------------------------------
    //0xb8018a00
    rtd_outl(TVE_IP_Y_GAIN_reg, TVE_IP_Y_GAIN_y_gain(0x205));
    //0xb8018880
    ...
    //0xb801889c
    rtd_outl(TVE_IP_SCTOH_3_reg, TVE_IP_SCTOH_sctoh(0x99));
    //0xb80188a0
    ...
    //0xb80188a8
    rtd_outl(TVE_IP_BLCK_LVL_reg, TVE_IP_BLCK_LVL_black_lvl(0x78));
    //0xb80188ac
    ...
    //0xb80189c0
    rtd_outl(TVE_IP_SYNC_LVL2_reg, TVE_IP_SYNC_LVL2_sync_lvl_h(0x58));
    //0xb80189c4
    rtd_outl(TVE_IP_SYNC_LVL3_reg, TVE_IP_SYNC_LVL3_sync_lvl_m(0x3e));
    //0xb80189c8
    rtd_outl(TVE_IP_SYNC_LVL4_reg, TVE_IP_SYNC_LVL4_sync_lvl_l(0x28));
    //C unit Low pass filter gain-----------------------------------------------
    //0xb80189cc
    rtd_outl(TVE_IP_SYNCLPF_GAIN_reg, TVE_IP_SYNCLPF_GAIN_clpf_gain(0x22));
    ...
    //0xb8018960
    rtd_outl(TVE_IP_MVPBZ1_reg, TVE_IP_MVPBZ1_mvpbz1(0x8)| //N17
    ...
    //0xb801896c
    rtd_outl(TVE_IP_MVPCSLIMD1_reg, TVE_IP_MVPCSLIMD1_mvpcslimd_msb(0x01)); //N21(MSB)
    ...
    //0xb80189d4
    rtd_outl(TVE_IP_SYNC_END_reg, TVE_IP_SYNC_END_sync_end(0x40));
    //0xb80189d8
    ...
    //0xb80189ec
    rtd_outl(TVE_IP_NBRST_STRT_reg, TVE_IP_NBRST_STRT_nbrst_strt(0x56));
    //0xb80189f0
    rtd_outl(TVE_IP_NBRST_END_reg, TVE_IP_NBRST_END_nbrst_end(0x74));
    ...
    rtd_outl(TVE_I_COLORBAR_HPOS_reg,
                     ...
                     TVE_I_COLORBAR_HPOS_write_en1(1)|TVE_I_COLORBAR_HPOS_i_h_st_pos(62));
    return;
}
