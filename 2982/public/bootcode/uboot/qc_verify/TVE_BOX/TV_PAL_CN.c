//#######################################################################################################
//
//  File Name:      TV_PAL_CN.C
//  Description:    PAL-CN initial setting
//
//#######################################################################################################
#include "TVE_reg.h"
#include "qc_verify.h"
...
void TVE_TV_PAL_CN(UINT32 colorbar)
{
    ...
    //0xb8018880
	rtd_outl(TVE_IP_PHS_0_reg, TVE_IP_PHS_phi(0x46));
	//0xb8018884 
	rtd_outl(TVE_IP_PHS_1_reg, TVE_IP_PHS_phi(0x94));
	//0xb8018888 
	rtd_outl(TVE_IP_PHS_2_reg, TVE_IP_PHS_phi(0xf6));
	//0xb801888c 
	...
	rtd_outl(TVE_SYNCGEN_I_reg,
	            	 TVE_SYNCGEN_I_write_en2(1)|TVE_SYNCGEN_I_v_thr(624)| //0x270
					 TVE_SYNCGEN_I_write_en1(1)|TVE_SYNCGEN_I_h_thr(863)); //0x35f
    // 0xb8018008
	...
	rtd_outl(TVE_IP_VSYNCPOS_reg,
	                 TVE_IP_VSYNCPOS_write_en2(1)|TVE_IP_VSYNCPOS_ip_vsync_pos1(309)| //0x135
					 TVE_IP_VSYNCPOS_write_en1(1)|TVE_IP_VSYNCPOS_ip_vsync_pos2(621)); //0x26d
	// 0xb80180b4
	rtd_outl(TVE_IP_HSYNCPOS_reg, TVE_IP_HSYNCPOS_hthr(795)); //0x31b
