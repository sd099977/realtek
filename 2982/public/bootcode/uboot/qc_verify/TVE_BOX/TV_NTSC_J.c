//############################################################################################################
//
// File Name: TV_NTSC_J.c
// Description: TV Encoder NTSC-J for CVBS initial setting
// Parameter:
...
void TVE_TV_NTSC_J(void)
{
    ...
    //Y gain--------------------------------------------------------------------
    //0xb8018a00
    rtd_outl(TVE_IP_Y_GAIN_reg, TVE_IP_Y_GAIN_y_gain(0x224));
    //0xb8018880
    ...
    //0xb80188a8 
    rtd_outl(TVE_IP_BLCK_LVL_reg, TVE_IP_BLCK_LVL_black_lvl(0x70));
    //0xb80188ac
    rtd_outl(TVE_IP_BLNK_LVL_reg, TVE_IP_BLNK_LVL_blank_lvl(0x70));
    //0xb80188b0
