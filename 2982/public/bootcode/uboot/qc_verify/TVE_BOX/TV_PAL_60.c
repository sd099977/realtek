//#######################################################################################################
//
//  File Name:      TV_PAL_60.C
//  Description:    PAL-60 initial setting
//
//#######################################################################################################
#include "TVE_reg.h"
#include "qc_verify.h"
...
void TVE_TV_PAL_60(UINT32 colorbar)
{
	...
	rtd_outl(TVE_IP_S_CTRL_reg, TVE_IP_S_CTRL_t_hsync_phs(0)|
					...
					TVE_IP_S_CTRL_y_tencd_mode(2));//select PAL_M                     
	// 0xb80188e4 
	...
	// 0xb80188f8 
	rtd_outl(TVE_IP_HLC1_reg, TVE_IP_HLC1_hlc(0x58));
    ...
    // 0xb80189cc 
	rtd_outl(TVE_IP_SYNCLPF_GAIN_reg, TVE_IP_SYNCLPF_GAIN_clpf_gain(0x18));	
	//==============================================================================
	//Macrovision
	//==============================================================================
	...
	// 0xb8018924 
	rtd_outl(TVE_IP_MVCSL1_reg, TVE_IP_MVCSL1_mvcsl1(0x3a)); //N1*2+5
	// 0xb8018928 
	rtd_outl(TVE_IP_MVCLS1_reg, TVE_IP_MVCLS1_mvcls1(0x11)); //N2
	// 0xb801892c 
	rtd_outl(TVE_IP_MVCSL2_reg, TVE_IP_MVCSL2_mvcsl2(0x4b)); //N3*2+6
	// 0xb8018930 
	...
	// 0xb8018968 
	rtd_outl(TVE_IP_MVPCSLIMD0_reg, TVE_IP_MVPCSLIMD0_mvpcslimd_lsb(0x0));	//N21(LSB)
	// 0xb801896c 
	rtd_outl(TVE_IP_MVPCSLIMD1_reg, TVE_IP_MVPCSLIMD1_mvpcslimd_msb(0x0));	//N21(MSB)	
	...
	// 0xb80180b4
	rtd_outl(TVE_IP_HSYNCPOS_reg, TVE_IP_HSYNCPOS_hthr(793)); //0x319
	...
	rtd_outl(TVE_AV_I_HPOS_reg,
	                 TVE_AV_I_HPOS_write_en2(1)|TVE_AV_I_HPOS_i_h_st(68)|
					 TVE_AV_I_HPOS_write_en1(1)|TVE_AV_I_HPOS_i_h_end(787)); //(143,862) (136,855)
	...
	rtd_outl(TVE_ITOP_VPOS_reg,
					 ...
					 TVE_ITOP_VPOS_write_en1(1)|TVE_ITOP_VPOS_itop_v_end(260)); //(23,309)
    // 0xb8018060
	rtd_outl(TVE_IBOT_VPOS_reg,
	                 TVE_IBOT_VPOS_write_en2(1)|TVE_IBOT_VPOS_ibot_v_st(284)|
					 TVE_IBOT_VPOS_write_en1(1)|TVE_IBOT_VPOS_ibot_v_end(523)); //(334,621)
	...
	rtd_outl(TVE_AV_P_HPOS1_reg,
					 ...
					 TVE_AV_P_HPOS1_write_en1(1)|TVE_AV_P_HPOS1_p_h_end(856)); //(136,855)
    // 0xb8018064
	rtd_outl(TVE_P_VPOS1_reg,
	                 TVE_P_VPOS1_write_en2(1)|TVE_P_VPOS1_p_v_st(42)|
					 TVE_P_VPOS1_write_en1(1)|TVE_P_VPOS1_p_v_end(521)); //(43,618) (44,619)

    //HDMI Hpos
	// 0xb8018058 
	rtd_outl(TVE_AV_H_HPOS1_reg,
	                 TVE_AV_H_HPOS1_write_en3(1)|TVE_AV_H_HPOS1_h_av_cord(0)|//1)| //1:progressive sync-gen 
					 TVE_AV_H_HPOS1_write_en2(1)|TVE_AV_H_HPOS1_h_h_st(68)|
					 TVE_AV_H_HPOS1_write_en1(1)|TVE_AV_H_HPOS1_h_h_end(787));
    // 0xb801806C
	...
	rtd_outl(TVE_I_COLORBAR_HPOS_reg,
					 ...
					 TVE_I_COLORBAR_HPOS_write_en1(1)|TVE_I_COLORBAR_HPOS_i_h_st_pos(0x50));//68));
