//############################################################################################################
//
// File Name: TV_720p60.c
// Description: TV Encoder 720p/60Hz initial setting
// Parameter:
...
//                     TVE_DAC_MUX_write_en4(1)|TVE_DAC_MUX_up_ctrl_int1(1)|
                     TVE_DAC_MUX_write_en5(1)|TVE_DAC_MUX_up_ctrl_int0(0)|//for Saturn FPGA
    ...
    rtd_outl(TVE_SYNCGEN_P_reg,
                     ...
                     TVE_SYNCGEN_P_write_en1(1)|TVE_SYNCGEN_P_h_thr(1649));
    //0xb801800c
    rtd_outl(TVE_SYNCGEN_HDMI_reg,
                     ...
                     TVE_SYNCGEN_HDMI_write_en1(1)|TVE_SYNCGEN_HDMI_h_thr(1649));
    ...
    rtd_outl(TVE_AV_P_HPOS1_reg,
                     ...
                     TVE_AV_P_HPOS1_write_en2(1)|TVE_AV_P_HPOS1_p_h_st(363)|
                     TVE_AV_P_HPOS1_write_en1(1)|TVE_AV_P_HPOS1_p_h_end(1643));
    //0xb8018064
    ...
    rtd_outl(TVE_AV_H_HPOS1_reg,
                     ...
                     TVE_AV_H_HPOS1_write_en2(1)|TVE_AV_H_HPOS1_h_h_st(363)|
                     TVE_AV_H_HPOS1_write_en1(1)|TVE_AV_H_HPOS1_h_h_end(1643));
    //0xb801806c
    ...
    rtd_outl(TVE_COMP_VSYNC_HPOS_reg,
                     TVE_COMP_VSYNC_HPOS_write_en3(1)|TVE_COMP_VSYNC_HPOS_negsyncst(67)|
                     TVE_COMP_VSYNC_HPOS_write_en2(1)|TVE_COMP_VSYNC_HPOS_possyncst(109)|
                     TVE_COMP_VSYNC_HPOS_write_en1(1)|TVE_COMP_VSYNC_HPOS_syncend(151));
    //0xb8018088
    rtd_outl(TVE_COMP_SER_HPOS_reg,
                     TVE_COMP_SER_HPOS_write_en2(1)|TVE_COMP_SER_HPOS_ser_hstart(363)|
                     TVE_COMP_SER_HPOS_write_en1(1)|TVE_COMP_SER_HPOS_ser_hend(1643));
    //0xb801808c
    ...
    rtd_outl(TVE_AV_COEFF3_reg,
                     TVE_AV_COEFF3_write_en2(1)|TVE_AV_COEFF3_c5(0x13a0)|
    ...
    rtd_outl(TVE_AV_COEFF4_reg,
                     ...
                     TVE_AV_COEFF4_write_en1(1)|TVE_AV_COEFF4_k2(0xC68));
    //0xb8018118
    rtd_outl(TVE_AV_COEFF5_reg,
                     TVE_AV_COEFF5_write_en1(1)|TVE_AV_COEFF5_vbi_gain_ebl(0)|
                     TVE_AV_COEFF5_write_en2(1)|TVE_AV_COEFF5_k3(0xbf0));
