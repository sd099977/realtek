//############################################################################################################
//
// File Name: TV_525p_700.c
// Description: TV Encoder 525p(700/300) for YPbPr initial setting
// Parameter:
...
void TVE_TV_525p_700(void)
{
    ...
    rtd_outl(TVE_AV_COEFF1_reg,
                     ...
                     TVE_AV_COEFF1_write_en1(1)|TVE_AV_COEFF1_c1(0x1374));
    //0xb801810c
...
*/
    ...
    rtd_outl(TVE_COMP_SYNCLVL_reg,
                     TVE_COMP_SYNCLVL_write_en3(1)|TVE_COMP_SYNCLVL_slewrate(0)|
    ...
    rtd_outl(TVE_COMP_BP_LVL_reg,
                     TVE_COMP_BP_LVL_write_en2(1)|TVE_COMP_BP_LVL_y_sync_l(0x2b6)|
