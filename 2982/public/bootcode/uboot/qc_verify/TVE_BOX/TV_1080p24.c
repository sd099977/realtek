//############################################################################################################
//
// File Name: TV_1080p24.c
// Description: TV Encoder 1080p/24Hz initial setting
...
void TVE_TV_1080p24(void)
{
    ...
    rtd_outl(TVE_SYNCGEN_P_reg,
                     ...
                     TVE_SYNCGEN_P_write_en1(1)|TVE_SYNCGEN_P_h_thr(2749));
    //0xb801800c
    rtd_outl(TVE_SYNCGEN_HDMI_reg,
                     ...
                     TVE_SYNCGEN_HDMI_write_en1(1)|TVE_SYNCGEN_HDMI_h_thr(2749));
    ...
    rtd_outl(TVE_P_COLORBAR_HPOS_reg,
                     ...
                     TVE_P_COLORBAR_HPOS_write_en1(1)|TVE_P_COLORBAR_HPOS_p_h_st_pos(309));
    //0xb801807c
    rtd_outl(TVE_H_COLORBAR_HPOS_reg,
                     TVE_H_COLORBAR_HPOS_write_en2(1)|TVE_H_COLORBAR_HPOS_p_h_width(239)|
                     TVE_H_COLORBAR_HPOS_write_en1(1)|TVE_H_COLORBAR_HPOS_p_h_st_pos(309));
    ...
    rtd_outl(TVE_COMP_VSYNC_HPOS_reg,
                     TVE_COMP_VSYNC_HPOS_write_en3(1)|TVE_COMP_VSYNC_HPOS_negsyncst(78)|
                     TVE_COMP_VSYNC_HPOS_write_en2(1)|TVE_COMP_VSYNC_HPOS_possyncst(122)|
                     TVE_COMP_VSYNC_HPOS_write_en1(1)|TVE_COMP_VSYNC_HPOS_syncend(166));
    //0xb8018088
    ...
    rtd_outl(TVE_AV_COEFF3_reg,
                     ...
                     TVE_AV_COEFF3_write_en1(1)|TVE_AV_COEFF3_c6(0x14c0));
    //0xb8018114
    ...
    rtd_outl(TVE_AV_COEFF5_reg,
                     ...
                     TVE_AV_COEFF5_write_en2(1)|TVE_AV_COEFF5_k3(0xb48));
