...
/* XXX U-BOOT XXX */
	...
	//scan block tag
	int (*scan_block_tag)(struct mtd_info *mtd, unsigned int from, unsigned int depth, unsigned int page_count,unsigned char block_tag);
	int (*rescue_image_read)(struct mtd_info *mtd, unsigned char* dst_buf, unsigned int from, unsigned int length, unsigned int page_count, const unsigned char magic);
