...
#define PHYSADDR(addr)	PHYS(addr)
...
//#define rtd_inl(addr)		REG32(addr)//; arom_mdelay(20);
//#define rtd_outl(addr, val)	(REG32(addr) = (u32)val)//; arom_mdelay(20);
...
//#define arom_mdelay(m) udelay(m)
#define test_delay(n)   sys_wait_us(n)
