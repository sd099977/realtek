...
//=================================================================================================
#ifdef FPGA
#define TIMERINFO_BASE_CLOCK				(25000000)	//T = 1/25M = 40ns
#define TIMERINFO_BASE_UNIT					40		// 40ns
#else
...
#define TIMERINFO_INT_BASE_ADDRESS			0x1801B008
#ifdef ENV_MACARTHUR
#define TIMERINFO_INT_TIMER0_BIT			6
#define TIMERINFO_INT_TIMER1_BIT			7
#define TIMERINFO_INT_TIMER2_BIT			8
#define TIMERINFO_INT_TIMER3_BIT			9
#define TIMERINFO_INT_TIMER4_BIT			10
#define TIMERINFO_INT_TIMER5_BIT			11
#define TIMERINFO_INT_TIMER6_BIT			12
#define TIMERINFO_INT_TIMER7_BIT			13
#else
...
#define TIMERREG_BASE_ADDRESS				0x1801B600	//Base Address of Timer Register Set
